...
def draw_mask_slam(slam_mask): # TODO
    points = [
    (14, 1306), (412, 1534), (502, 1416), (666, 1450), (926, 1278), (946, 1292), 
    (1420, 1248), 
    (1838, 1500), 
    (1938, 1476), (2238, 1622), (2700, 1320), (2702, 2016), (1704, 2024), (922, 2024), (2, 2024)
    ]
    points = np.array(points, dtype=np.int32)
    cv2.fillPoly(slam_mask, [points], (0, 0, 0), lineType=cv2.LINE_AA)
    return slam_mask


# 擦除aruco tag，用边界点的平均颜色填充
